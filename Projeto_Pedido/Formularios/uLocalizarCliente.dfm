object fLocalizarCliente: TfLocalizarCliente
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'fLocalizarCliente'
  ClientHeight = 480
  ClientWidth = 619
  Color = clBtnFace
  ...
  object qryLocalizar: TFDQuery
    ...
    Left = 24
    Top = 201
    object qryLocalizarID_Cliente: TFDAutoIncField
      FieldName = 'ID_Cliente'
      Origin = 'ID_Cliente'
      ProviderFlags = [pfInWhere, pfInKey]
      DisplayFormat = '000000'
    end
    object qryLocalizarNM_Cliente: TStringField
      FieldName = 'NM_Cliente'
      Origin = 'NM_Cliente'
      Required = True
      Size = 80
